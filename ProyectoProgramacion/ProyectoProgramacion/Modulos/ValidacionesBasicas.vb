...
Friend Class ValidacionesBasicas
    ...
    Public Function validarNumeroTelefono(txtValidarTelefono As Bunifu.Framework.UI.BunifuMaterialTextbox) As Boolean
        Dim validador As New Regex("^\d{9}$")
    ...
    Public Function validarCedula(txtValidarTelefono As Bunifu.Framework.UI.BunifuMaterialTextbox) As Boolean
    ...
    Public Function validarCedula(txtValidarTelefono As TextBox) As Boolean
        Dim validador As New Regex("^\d{8}$")
    ...
    Public Function validarTexto(txtValidarTexto As Bunifu.Framework.UI.BunifuMaterialTextbox) As Boolean
